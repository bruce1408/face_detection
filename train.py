...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet, cfg_re50, cfg_vit
...
# from models.vit_model import RetinaFace
...
parser.add_argument('--resume_net', default="/mnt/share_disk/bruce_cui/Pytorch_Retinaface/weights/vit_epoch_30.pth", help='resume net for retraining')
...
# net = ViTforObjectDetection(cfg=cfg)
